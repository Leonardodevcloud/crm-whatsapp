    ...
    <>
      ...
      <aside className={clsx(
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          <button onClick={logout} className="flex items-center gap-2 text-gray-600 hover:text-red-600 transition-colors w-full px-2 py-2 rounded-lg hover:bg-gray-50">
